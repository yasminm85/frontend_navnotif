...
import { Box, Card, CardContent, Typography, TextField, Button, CircularProgress, InputAdornment, Stack } from '@mui/material';
import { Email as EnvelopeIcon, Lock as LockClosedIcon, ArrowBack as ArrowLeftIcon } from '@mui/icons-material';
        ...
        <CardContent sx={{ p: 4 }}>
          ...
          {!isEmailSent && (
            <Box component="form" onSubmit={handleEmailSubmit}>
              ...
              />
              <Button type="submit" fullWidth variant="contained" size="large" disabled={loading} sx={{ py: 1.2, borderRadius: 2 }}>
          ...
          {isEmailSent && !isOtpSubmited && (
            <Box component="form" onSubmit={handleOtpSubmit}>
              ...
              <Typography align="center" variant="body2" color="text.secondary" sx={{ mt: 2 }}>
                Tidak menerima kode?{' '}
                <Box component="span" onClick={handleResendOtp} sx={{ color: 'primary.main', fontWeight: 500, cursor: 'pointer' }}>
                  Kirim ulang
                </Box>
              </Typography>
            </Box>
            ...
            {[1, 2, 3].map((s) => (
              <Box
                ...
                sx={{
                  ...
                  borderRadius: 99,
                  bgcolor: s === currentStep ? 'primary.main' : s < currentStep ? 'success.main' : 'grey.300',
