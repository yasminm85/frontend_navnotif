      ...
      <MainCard title="Dashboard">
        ...
        >
          {selectedLaporan ? (
            <div className="mt-3">
              ...
              <div className="relative">
                <InputTextarea value={htmlToPlainText(selectedLaporan)} disabled rows={5} cols={30} style={{ whiteSpace: 'pre-wrap' }} />
          ...
          <Typography className="mt-3">
            Ditulis Tanggal: {formDate(laporanat) ?? '-'} - Jam: {formTimeLaporan(laporanat) ?? '-'}
          </Typography>
        ...
        >
          ...
          <Typography className="mt-3">
            Ditulis Tanggal: {formDate(laporanatTambahan) ?? '-'} - Jam: {formTimeLaporan(laporanatTambahan) ?? '-'}
          </Typography>
        </Dialog>

        <Dialog header="Isi Laporan" visible={visible} maximizable style={{ width: '50vw' }} onHide={() => setVisible(false)}>
        ...
        <Dialog header="Isi Laporan Tambahan" visible={visible2} maximizable style={{ width: '50vw' }} onHide={() => setVisible2(false)}>
          <div
            className="ql-editor"
        ...
        <DataTable value={showDisposisi} paginator rows={5} loading={loading} dataKey="_id">
          ...
          <Column
            field="laporan_tambahan"
            header="Laporan Tambahan"
            body={laporanTambahanBodyTemplate}
